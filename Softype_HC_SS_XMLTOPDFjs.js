...
function suitelet(request, response){
    ...
    html+='<p>'+nlapiEscapeXML('Ventus Infotech Pvt.Ltd')+'<br/>'+nlapiEscapeXML('21 Morvi House 2nd Floor')+'<br/>'+nlapiEscapeXML('28/30 Goa Street,Ballard Estate')+'<br/>'+nlapiEscapeXML('Mumbai-400001.')+'</p>';				
	html+='</div>';
	...
	html+= ' <thead>';
	html+= '<tr>';
	html+= '<th>'+nlapiEscapeXML('Employee Name:')+'<br/>'+nlapiEscapeXML('Month & year')+'</th>';
	html+= '<th>';
	html+= '<table class="border-less">';
	html+= '<tr class="border-bottom">';
	html+= '<th>'+nlapiEscapeXML('Designation')+'</th>';
	html+= '</tr>';
	html+= '<tr class="border-bottom">';
	html+= '<th>'+nlapiEscapeXML('Department')+'</th> ';                                     
	html+= '</tr>';
	html+= '<tr class="">';
	html+= '<th>'+nlapiEscapeXML('Employee PF No')+'</th>';                                   
	html+= '</tr>';
	...
	html+= '</tr>';
	html+= '<tr>';
	html+= '<th class="text-center">'+nlapiEscapeXML('Earning')+'</th>';
	html+= '<th class="text-center">'+nlapiEscapeXML('Deduction')+'</th>';
	html+= '</tr>';
	html+= '</thead>';
	...
	html+= '<td class="text-center border-right" colspan="2">'+nlapiEscapeXML('Gross Pay')+'</td>';
	html+= '<td class=""></td>';
	html+= '</tr>';
	html+= '</table>';
	...
	html+= '<td>'+nlapiEscapeXML('Net Payable')+'</td>';
	html+= '<td ></td>';
	html+= '</tr>';
	html+= '</table>';
   ...
   html+= '</html>';
		...
		var xml = "<?xml version=\"1.0\"?>\n<!DOCTYPE pdf PUBLIC \"-//big.faceless.org//report\" \"report-1.1.dtd\">\n";
		 xml += "<pdf>\n";
		  ...
		  response.setContentType('PDF','Deposite.pdf','inline');
